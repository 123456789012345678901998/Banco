...
public class Transferencia extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        cantidad = Integer.parseInt(txtDeposito.getText());
        saldoi = Integer.parseInt(saldo);
        op = saldoi + cantidad;
        ops = Integer.toString(op);
        System.out.println("El Deposito de Efectivo es de:" +cantidad);
        JOptionPane.showConfirmDialog(null, "La cantidad a depositar es de:" +cantidad);
